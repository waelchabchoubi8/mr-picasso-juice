    ...
    <footer className="bg-warm text-white/70 pt-12 lg:pt-16 pb-8 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-coral to-sunny flex items-center justify-center shadow-md">
                <span className="text-white font-playfair font-bold text-base">M</span>
              </div>
              <div>
                <p className="font-playfair text-white font-semibold text-sm leading-tight">Masmoudi</p>
                <p className="text-white/35 text-xs">Sfax, Tunisie</p>
              </div>
            </div>
            <p className="text-white/45 text-sm leading-relaxed">
              Pâtisserie tunisienne d&apos;exception.<br />
              L&apos;art du sucré depuis 1969.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: 'Coffret Masmoudi', href: '/#palette' },
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex gap-2.5 items-start">
                ...
                <span className="text-white/50 leading-relaxed">Route de Tunis, Sfax<br/>Tunisie</span>
              </li>
              ...
              <li className="flex gap-2.5 items-center">
                ...
                <a href="mailto:contact@masmoudi.tn" className="text-white/50 hover:text-white transition-colors cursor-pointer text-xs">
                  contact@masmoudi.tn
                </a>
              </li>
            </ul>
            ...
            <a
              href={`https://wa.me/21600000000?text=${encodeURIComponent('Bonjour Masmoudi, je voudrais commander.')}`}
              target="_blank"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/25">
          <p>© 2025 Masmoudi · Sfax, Tunisie · Tous droits réservés</p>
          <a
