...
const REVIEWS = [
  {
    ...
    city: 'Tunis',
    rating: 5,
    text: 'La meilleure baklawa que j\'ai goûtée — feuilletée, généreuse en pistache, pas trop sucrée. Un délice.',
    fruit: '🍯',
  },
  {
    name: 'Ahmed K.',
    city: 'La Marsa',
    rating: 5,
    text: 'Le coffret 36 pièces est parfait pour les fêtes. Toute la famille en raffole, je recommande les yeux fermés.',
    fruit: '🎁',
  },
  {
    name: 'Fatma R.',
    city: 'Sfax',
    rating: 5,
    text: 'Composer mon propre coffret, pièce par pièce — quelle belle idée ! Mlabes et baklawa pistache, un régal.',
    fruit: '🌰',
  },
  {
    name: 'Youssef M.',
    city: 'Ennasr',
    rating: 5,
    text: 'Qualité constante, livraison rapide partout en Tunisie. Masmoudi, c\'est une véritable institution.',
    fruit: '🥮',
  },
];
